...
def rewrite_standard_task(
    self,
    text: str,
    user_id: int,
    mode: str = "standard",
    free_attempts_remaining: int | None = None,
    charge_words: bool = False,
) -> dict[str, Any]:
